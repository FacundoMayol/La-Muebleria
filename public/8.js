  ...
  return _c(
    ...
    [
      _c(
        ...
        {
          staticClass:
            "text-center text-2xl sm:text-4xl lg:text-5xl font-semibold text-orange-500"
        },
        [_vm._v("Lo sentimos")]
      ),
      _vm._v(" "),
      _c(
        ...
        {
          staticClass:
            "text-center text-base sm:text-xl lg:text-2xl tracking-tight font-light"
        },
        [_vm._v("El recurso solicitado no pudo ser encontrado")]
      ),
      _vm._v(" "),
      _c(
        "button",
        {
          staticClass: "btn-outlined btn-outlined-orange p-2 mt-2",
          on: { click: _vm.back }
        },
        [_vm._v("Volver atrás")]
      )
